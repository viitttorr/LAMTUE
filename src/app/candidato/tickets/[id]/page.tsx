...
export default async function CandidatoTicketPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!ticket || ticket.user_id !== s.id) redirect("/candidato/tickets");
  ...
  return <TicketThread area="candidato" ticket={ticket} mensagens={mensagens} meuId={s.id} souDiretoria={false} />;
}
