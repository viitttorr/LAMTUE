...
export default async function DiretoriaTicketPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!ticket) redirect("/diretoria/tickets");
  ...
  return <TicketThread area="diretoria" ticket={ticket} mensagens={mensagens} meuId={s.id} souDiretoria={true} />;
}
